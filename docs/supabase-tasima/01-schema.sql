-- =====================================================================
-- NB Steelora — Supabase taşıma paketi · 01 ŞEMA
-- Kaynak proje: npvanotrzbqsnxvasmxm (ap-southeast-1 / Singapur)
-- Hedef proje : YENİ (eu-central-1 / Frankfurt)
--
-- Bu dosya YENİ ve BOŞ projede bir kez çalıştırılır. Veri içermez.
-- Sıra: 01-schema.sql → 02-policies.sql → veri kopyası → 05-dogrulama.sql
--
-- Not: auth.users tablosu Supabase tarafından yönetilir; buradaki yabancı
-- anahtarlar ona bağlanır. Kullanıcılar taşınmadan önce oluşturulmalıdır
-- (bkz. 06-bb-adimlari.md — Auth bölümü), aksi hâlde user_id'li satırlar
-- yazılamaz.
-- =====================================================================

-- Uzantılar (kaynakta kurulu olanlar) --------------------------------------
