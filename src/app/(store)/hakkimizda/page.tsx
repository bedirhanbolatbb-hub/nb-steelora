...
export default function HakkimizdaPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 lg:px-8 py-16">
      ...
      <p className="font-heading text-[22px] text-ink italic leading-relaxed mb-10">
        &ldquo;Her parça bir hikaye anlatır. NB Steelora®, bu hikayeleri zarafetle hayata
        geçirir.&rdquo;
      </p>

      <div className="space-y-6 text-[13px] font-body text-ink-soft leading-relaxed">
        <p>
        ...
        <h2 className="font-heading text-[24px] font-light text-ink mt-10 mb-4">
          Felsefemiz
        </h2>
        <p>
