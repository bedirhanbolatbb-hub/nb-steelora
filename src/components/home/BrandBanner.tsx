    ...
    <section className="bg-dark-mid">
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-20 flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <h2 className="font-heading text-[36px] lg:text-[42px] font-light text-champagne mt-4 leading-tight">
            Sevdiklerinize özel
            <br />
            <span className="italic text-gold">hediye paketi</span>
          </h2>
          <p className="text-[12px] font-body text-champagne-mid/60 mt-4 leading-relaxed max-w-md mx-auto lg:mx-0">
